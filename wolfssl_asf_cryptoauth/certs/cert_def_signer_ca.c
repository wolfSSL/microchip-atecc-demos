...
const uint8_t g_signer_root_ca_public_key[64] = {
...
const uint8_t g_cert_template_signer_ca[] = {
...
const atcacert_def_t g_cert_def_signer_ca = {
    .type                   = CERTTYPE_X509,
    .template_id            = 1,
    .chain_id               = 0,
    .private_key_slot       = 0,
    ...
    .cert_template          = g_cert_template_signer_ca,
    .cert_template_size     = sizeof(g_cert_template_signer_ca),
};
